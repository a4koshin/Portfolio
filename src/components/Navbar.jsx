...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-4 right-4 md:right-[312px] flex justify-between items-center w-auto  backdrop-blur-md border border-gray-200 rounded-full z-50 px-6 py-1">
