...
const HomePage = () => {
  ...
  return (
    <>
      <div className="mb-32">
        <div className="mx-auto max-w-7xl px-4">
          <div className="relative mx-auto max-w-7xl mt-4 md:mt-16 px-4 flex flex-col justify-center items-center gap-12">
            ...
            <div className="w-full max-w-sm md:max-w-md md:absolute md:top-96 md:-left-8 backdrop-blur-xl border border-gray-300/60 rounded-3xl p-8 shadow-2xl shadow-blue-400/10 hover:shadow-blue-400/20 transition-all duration-500 bg-gradient-to-br from-white/20 to-blue-50/30 hover:from-white/30 hover:to-blue-50/40 hover:-translate-y-1 hover:scale-105 group  ">
            ...
            <div className="w-full max-w-md md:absolute md:top-96 md:-right-8 backdrop-blur-xl border border-gray-300/60  rounded-3xl p-6 md:p-8 shadow-2xl shadow-blue-400/10 hover:shadow-blue-400/20 transition-all duration-500 bg-gradient-to-br from-white/20 to-blue-50/30 hover:from-white/30 hover:to-blue-50/40 hover:-translate-y-1 hover:scale-105 group mx-auto md:mx-0">
              {/* Animated background elements */}
              <div className="absolute inset-0 rounded-3xl bg-gradient-to-r from-blue-400/10 to-blue-400/10 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
      ...
      <div className="mb-16 bg-[#007bff] px-4 py-12 sm:px-6 sm:py-16 lg:px-8 lg:py-24 rounded-md">
